...
import { analyze3mfSupports } from "./support/support-analyzer.js";
import { render3mfPreview } from "./render/support-preview.js";
            ...
            try {
                ...
                switch (name) {
                    case "analyze_3mf_supports": {
                        const analysis = await analyze3mfSupports(args, { signal: extra.signal });
                        return {
                    ...
                    case "render_3mf_preview": {
                        const preview = await render3mfPreview(args, extra.signal);
                        return createPreviewMcpResult(preview);
                    }
